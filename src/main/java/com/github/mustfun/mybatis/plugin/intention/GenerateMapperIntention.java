...
import com.github.mustfun.mybatis.plugin.template.MybatisFileTemplateDescriptorFactory;
import com.github.mustfun.mybatis.plugin.ui.ClickableListener;
...
public class GenerateMapperIntention extends GenericIntention {
    ...
    public String getText() {
        return "[Mybatis] Create new xml statement";
    }
